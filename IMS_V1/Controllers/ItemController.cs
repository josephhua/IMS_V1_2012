...
//            return RedirectToAction("Edit", "Item", new { id =item.Item_id });
        ...
        //public void APlusImportITBAL(string APlusImportKeyCode)
        //{
        //    var results1 = db.APlusImport_ITBAL(APlusImportKeyCode);
        //    ViewBag.ITBAL = results1.ToList();
        //}
        //public void APlusImportITMST(string APlusImportKeyCode)
        //{
        //    var results2 = db.APlusImport_ITMST(APlusImportKeyCode);
        //    ViewBag.ITMST = results2.ToList();
        //}
        //public void APlusImportZADITM(string APlusImportKeyCode)
        //{
        //    var results3 = db.APlusImport_ZADITM(APlusImportKeyCode);
        //    ViewBag.ZADITM = results3.ToList();
        //}
