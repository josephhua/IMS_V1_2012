...
namespace IMS_V1.Controllers
{
    public class Attribute_LookupController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            //var attributelookup = db.Attribute_Lookup.Where(al => al.AttributeType_Id == id && al.Active == true).OrderBy(al => al.WebsiteAttributeValue);
           ...
           //var attribute_lookup = db.Attribute_Lookup.Include(a => a.AttributeType);
