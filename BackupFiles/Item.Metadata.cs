...
namespace IMS_V1 
{
    ...
    public partial class Item
    {
        internal sealed class ItemMetadata
        {
            ...
            [RegularExpression("^([0-9][,]{0,1})?([0-9]{1,4})?(.[0-9]{2})?$", ErrorMessage = "Please enter a valid dollar amount.")]
            ...
            //public  IMS_V1.FineLineClass FineLineClass { get; set; }
            //public  IMS_V1.Freight_Lookup Freight_Lookup { get; set; }
            //public  IMS_V1.SubClass SubClass { get; set; }
            //public  IMS_V1.UM_Lookup UM_Lookup { get; set; }
            //public  IMS_V1.zManufacturersLogo zManufacturersLogo { get; set; }
